...
export default function KnowledgeJobsClient(props: { locale: string }) {
  ...
  async function refresh() {
    ...
    try {
      ...
      const url =
        kind === "index"
          ? `${API_BASE}/governance/knowledge/index-jobs?${q.toString()}`
          : kind === "embedding"
            ? `${API_BASE}/governance/knowledge/embedding-jobs?${q.toString()}`
            : `${API_BASE}/governance/knowledge/ingest-jobs?${q.toString()}`;

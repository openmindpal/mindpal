...
export default function ChangeSetDetailClient(props: { locale: string; changesetId: string; initial: unknown; initialStatus: number }) {
  ...
  async function refreshPipeline(nextMode?: "full" | "canary") {
    ...
    const res = await fetch(`${API_BASE}/governance/changesets/${encodeURIComponent(props.changesetId)}/pipeline?mode=${encodeURIComponent(useMode)}`, {
  ...
  async function refresh() {
    setError("");
    const res = await fetch(`${API_BASE}/governance/changesets/${encodeURIComponent(props.changesetId)}`, { headers: apiHeaders(props.locale), cache: "no-store" });
  ...
  async function addItem() {
    ...
    await runAction(async () => {
      const res = await fetch(`${API_BASE}/governance/changesets/${encodeURIComponent(props.changesetId)}/items`, {
        method: "POST",
  ...
  async function submit() {
    await runAction(async () => {
      const res = await fetch(`${API_BASE}/governance/changesets/${encodeURIComponent(props.changesetId)}/submit`, {
        method: "POST",
        headers: apiHeaders(props.locale),
      });
      const json: unknown = await res.json().catch(() => null);
  ...
  async function approve() {
    await runAction(async () => {
      const res = await fetch(`${API_BASE}/governance/changesets/${encodeURIComponent(props.changesetId)}/approve`, {
        method: "POST",
        headers: apiHeaders(props.locale),
      });
      const json: unknown = await res.json().catch(() => null);
  ...
  async function doPreflight() {
    ...
    await runAction(async () => {
      ...
      const res = await fetch(`${API_BASE}/governance/changesets/${encodeURIComponent(props.changesetId)}/preflight?mode=${encodeURIComponent(mode)}`, {
        method: "POST",
        headers: apiHeaders(props.locale),
      });
      const json: unknown = await res.json().catch(() => null);
  ...
  async function release() {
    await runAction(async () => {
      const res = await fetch(`${API_BASE}/governance/changesets/${encodeURIComponent(props.changesetId)}/release?mode=${encodeURIComponent(mode)}`, {
        method: "POST",
        headers: apiHeaders(props.locale),
      });
      const json: unknown = await res.json().catch(() => null);
  ...
  async function triggerEvalRun(suiteId: string) {
    await runAction(async () => {
      const res = await fetch(`${API_BASE}/governance/evals/suites/${encodeURIComponent(suiteId)}/runs`, {
        method: "POST",
        headers: { ...apiHeaders(props.locale), "content-type": "application/json" },
  ...
  async function promote() {
    await runAction(async () => {
      const res = await fetch(`${API_BASE}/governance/changesets/${encodeURIComponent(props.changesetId)}/promote`, {
        method: "POST",
        headers: apiHeaders(props.locale),
      });
      const json: unknown = await res.json().catch(() => null);
  ...
  async function rollback() {
    await runAction(async () => {
      const res = await fetch(`${API_BASE}/governance/changesets/${encodeURIComponent(props.changesetId)}/rollback`, {
        method: "POST",
        headers: apiHeaders(props.locale),
      });
      const json: unknown = await res.json().catch(() => null);

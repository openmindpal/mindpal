/**
 * Shared SVG icon components for all shell/ sub-panels.
 * Eliminates ~30 duplicate inline-icon definitions across 7 files.
 */

/* ─── Status / Action Icons (12×12, used in lists) ─────────────────────────── */
...
/* ─── Panel-level Icons (14×14, used in headers / tabs / badges) ───────────── */
...
export function IconDeadletter() {
  return (
    <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
...
/* ─── 14×14 variants for RunHistoryPanel expand/collapse ───────────────────── */

export function IconChevronDown14() {
...
export function IconChevronUp14() {
...
/* ─── RecentAndFavorites-specific icons ─────────────────────────────────────── */

export function IconStar(props: { filled?: boolean }) {
  return (
    <svg width="14" height="14" viewBox="0 0 24 24" fill={props.filled ? "currentColor" : "none"} stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
/* ─── NotificationPanel-specific (IconCheck at 14×14) ──────────────────────── */

export function IconCheckLg() {

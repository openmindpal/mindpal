...
export const openaiCompatibleProviders = ["openai_compatible", "deepseek", "hunyuan", "qwen", "zhipu", "doubao", "kimi", "ernie", "spark", "baichuan", "yi", "minimax", "step", "sensenova", "custom_openai"] as const;

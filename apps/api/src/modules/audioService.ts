        ...
        messages: [
          {
            ...
            content: [
              ...
              { type: "input_audio", input_audio: { data: audioBase64, format: mimeType } },
            ],
          },
        ],
      }),
...
export function getAudioCapabilities(): { stt: { ready: boolean }; tts: { ready: boolean } } {
  ...
  return { stt: { ready: sttReady }, tts: { ready: ttsReady } };
}

  ...
  return {
    ...
    multimodalConfig: {
      ...
      ...(hardware?.hasMicrophone ? {
        streaming: { supported: true, maxConcurrentStreams: 1 },
        vad: { enabled: true, silenceThresholdMs: 600, adaptiveThreshold: true },
      } : {}),
      ...(hardware?.hasCamera ? {
        videoStream: { supported: true, frameIntervalMs: 1000, maxFrameWidth: 640, format: "jpeg" as const },
      } : {}),
    },
  };
}

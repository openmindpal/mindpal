...
/** 设备支持的模态类型 */
export type DeviceModality = string;

export const BUILTIN_DEVICE_MODALITIES: RegistryEntry[] = [
  builtInEntry('image', 'device.modality'),
  builtInEntry('audio', 'device.modality'),
  builtInEntry('video', 'device.modality'),
];

export const modalityRegistry = createRegistry(BUILTIN_DEVICE_MODALITIES);
...
export const BUILTIN_SKILL_RUNTIMES: RegistryEntry[] = [
  builtInEntry('python', 'skill.runtime'),
  builtInEntry('node', 'skill.runtime'),
  builtInEntry('go', 'skill.runtime'),
  builtInEntry('rust', 'skill.runtime'),
  builtInEntry('other', 'skill.runtime'),
];

export const runtimeRegistry = createRegistry(BUILTIN_SKILL_RUNTIMES);
...
export const BUILTIN_SENSITIVITY_PROFILES: RegistryEntry[] = [
  builtInEntry('quiet', 'device.vad.sensitivity'),
  builtInEntry('normal', 'device.vad.sensitivity'),
  builtInEntry('noisy', 'device.vad.sensitivity'),
  builtInEntry('auto', 'device.vad.sensitivity'),
];

export const sensitivityProfileRegistry = createRegistry(BUILTIN_SENSITIVITY_PROFILES);
...
export const JSONRPC_STANDARD_ERRORS = {
  PARSE_ERROR: -32700,
...
/** 自定义错误码注册表 */
export const BUILTIN_CUSTOM_ERRORS: RegistryEntry<number>[] = [
  builtInEntry('EXECUTION_TIMEOUT', 'skill.error', -32001),
  builtInEntry('EXECUTION_FAILED', 'skill.error', -32002),
  builtInEntry('RESOURCE_EXHAUSTED', 'skill.error', -32003),
  builtInEntry('POLICY_VIOLATION', 'skill.error', -32004),
  builtInEntry('DEPENDENCY_ERROR', 'skill.error', -32005),
  builtInEntry('CAPABILITY_DENIED', 'skill.error', -32006),
];

export const skillErrorCodeRegistry = createRegistry<number>(BUILTIN_CUSTOM_ERRORS);

...
exports.AFFORDANCE_PROMPT = exports.STATE_QUERY_PROMPT = exports.SPATIAL_QUERY_PROMPT = exports.IDENTIFY_PROMPT = exports.SCENE_ANALYSIS_PROMPT = void 0;
exports.buildPrompt = buildPrompt;
exports.SCENE_ANALYSIS_PROMPT = `You are a scene analysis system for an embodied robot agent. Analyze this image and return ONLY a valid JSON object with the following structure:
...
exports.IDENTIFY_PROMPT = `You are a scene analysis system. Find the object "{target}" in this image.
...
exports.SPATIAL_QUERY_PROMPT = `You are a spatial reasoning system. Answer this spatial question about the image:
...
exports.STATE_QUERY_PROMPT = `You are an object state analyzer. Determine the current state of "{object}" in this image.
...
exports.AFFORDANCE_PROMPT = `You are a robot manipulation advisor. Analyze what actions are physically possible on the object "{object}" visible in this image.
